...
export default function AppStoreIcon({ className, size = 24 }: AppStoreIconProps) {
  const id = useId();
  return (
    <svg
      width={size}
      ...
      className={className}
    >
      <circle cx="16" cy="16" r="14" fill={`url(#paint0_linear_appstore_${id})`} />
      <path
