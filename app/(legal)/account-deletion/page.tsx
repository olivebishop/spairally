...
import { IconBulletCircle } from "@/app/svg/icon-check-circle";
import { IconSuccessCheck } from "@/app/svg/icon-success-check";
import { RadarArcs } from "@/app/svg/radar-arcs";
import GrainOverlay, { NoiseTexture } from "@/app/shared/grain";
import { ACCOUNT_DELETION_DATA_ITEMS } from "@/data/account-deletion";
          ...
          <ul className="mt-5 space-y-2.5">
            {ACCOUNT_DELETION_DATA_ITEMS.map((item) => (
              <li key={item} className="flex items-start gap-2.5">
                <IconBulletCircle className="mt-0.5 shrink-0 text-white/30" />
        ...
        {submitted ? (
          <div className="relative mt-8 overflow-hidden rounded-none border border-white/[0.08] bg-[#111] p-6 sm:p-8 text-center">
            ...
            <div className="relative z-10 mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-none border border-white/[0.08] bg-white/[0.04]">
              <IconSuccessCheck className="text-white/70" />
            </div>
